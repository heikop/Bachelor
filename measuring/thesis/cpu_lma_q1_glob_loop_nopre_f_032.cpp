    ...
    for (size_t e=0; e < num_elem; e++) // ROLLED
    {
        for (size_t i{0}; i < 4; ++i)
        {
            for (size_t j{0}; j < 4; ++j)
            {
                ...
                {
                    float B[2][2] = // GLOBAL
                        { { ( -(1.0f-quadpoint[p][1])*static_cast<QuadrilateralQ1<float>*>(elements[e])->get_pointcoords()[0] + (1.0f-quadpoint[p][1])*static_cast<QuadrilateralQ1<float>*>(elements[e])->get_pointcoords()[1] + (1.0f+quadpoint[p][1])*static_cast<QuadrilateralQ1<float>*>(elements[e])->get_pointcoords()[2] - (1.0f+quadpoint[p][1])*static_cast<QuadrilateralQ1<float>*>(elements[e])->get_pointcoords()[3] ) ,
                            ( -(1.0f-quadpoint[p][0] )*static_cast<QuadrilateralQ1<float>*>(elements[e])->get_pointcoords()[0] - (1.0f+quadpoint[p][0] )*static_cast<QuadrilateralQ1<float>*>(elements[e])->get_pointcoords()[1] + (1.0f+quadpoint[p][0] )*static_cast<QuadrilateralQ1<float>*>(elements[e])->get_pointcoords()[2] + (1.0f-quadpoint[p][0] )*static_cast<QuadrilateralQ1<float>*>(elements[e])->get_pointcoords()[3] ) },
                          { ( -(1.0f-quadpoint[p][1])*static_cast<QuadrilateralQ1<float>*>(elements[e])->get_pointcoords()[4] + (1.0f-quadpoint[p][1])*static_cast<QuadrilateralQ1<float>*>(elements[e])->get_pointcoords()[5] + (1.0f+quadpoint[p][1])*static_cast<QuadrilateralQ1<float>*>(elements[e])->get_pointcoords()[6] - (1.0f+quadpoint[p][1])*static_cast<QuadrilateralQ1<float>*>(elements[e])->get_pointcoords()[7] ) ,
                            ( -(1.0f-quadpoint[p][0] )*static_cast<QuadrilateralQ1<float>*>(elements[e])->get_pointcoords()[4] - (1.0f+quadpoint[p][0] )*static_cast<QuadrilateralQ1<float>*>(elements[e])->get_pointcoords()[5] + (1.0f+quadpoint[p][0] )*static_cast<QuadrilateralQ1<float>*>(elements[e])->get_pointcoords()[6] + (1.0f-quadpoint[p][0] )*static_cast<QuadrilateralQ1<float>*>(elements[e])->get_pointcoords()[7] ) } };

                    // help vars
                    std::array<float, 2> grad1 = (i == 0 ? std::array<float, 2>{-(1.0f - quadpoint[p][1]),       // GLOBAL
                                                                                -(1.0f - quadpoint[p][0])} :
                                                 (i == 1 ? std::array<float, 2>{ (1.0f - quadpoint[p][1]),
                                                                                -(1.0f + quadpoint[p][0])} :
                                                 (i == 2 ? std::array<float, 2>{ (1.0f + quadpoint[p][1]),
                                                                                 (1.0f + quadpoint[p][0])} :
                                                           std::array<float, 2>{-(1.0f + quadpoint[p][1]),
                                                                                 (1.0f - quadpoint[p][0])} ) ) );
                    std::array<float, 2> grad2 = (j == 0 ? std::array<float, 2>{-(1.0f - quadpoint[p][1]),
                                                                                -(1.0f - quadpoint[p][0])} :
                                                 (j == 1 ? std::array<float, 2>{ (1.0f - quadpoint[p][1]),
                                                                                -(1.0f + quadpoint[p][0])} :
                                                 (j == 2 ? std::array<float, 2>{ (1.0f + quadpoint[p][1]),
                                                                                 (1.0f + quadpoint[p][0])} :
                                                           std::array<float, 2>{-(1.0f + quadpoint[p][1]),
                                                                                 (1.0f - quadpoint[p][0])} ) ) );
