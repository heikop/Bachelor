...
int main(int argc, char* argv[])
{
    ...
    for (size_t e=0; e < num_elem; e++) // ROLLED
    {
        ...
        std::array<double, 8> coords = static_cast<QuadrilateralQ2<double>*>(elements[e])->get_pointcoords();
        for (size_t i{0}; i < 9; ++i)
        {
            for (size_t j{0}; j < 9; ++j)
            {
                ...
                for (size_t p{0}; p < 9; ++p)
                {
                    ...
                    // help vars
                    std::array<double, 2> grad1 = (i == 0 ? std::array<double, 2>{(1.0 - 2.0 * xi) * eta * (1.0 - eta) ,       // LOCAL
                                                                                 xi * (1.0 - xi) * (1.0 - 2.0 * eta) } :
                                                 (i == 1 ? std::array<double, 2>{-(1.0 + 2.0 * xi) * eta * (1.0 - eta),
                                                                                - xi * (1.0 + xi) * (1.0 - 2.0 * eta)} :
                                                 (i == 2 ? std::array<double, 2>{(1.0 + 2.0 * xi) * eta * (1.0 + eta) ,
                                                                                 xi * (1.0 + xi) * (1.0 + 2.0 * eta) } :
                                                 (i == 3 ? std::array<double, 2>{-(1.0 - 2.0 * xi) * eta * (1.0 + eta),
                                                                                - xi * (1.0 - xi) * (1.0 + 2.0 * eta)} :
                                                 (i == 4 ? std::array<double, 2>{xi * eta * (1.0 - eta) ,
                                                                                -(1.0 - xi) * (1.0 + xi) * (2.0 - 4.0 * eta) } :
                                                 (i == 5 ? std::array<double, 2>{(2.0 + 4.0 * xi) * (1.0 - eta) * (1.0 + eta) ,
                                                                                 -xi * (1.0 + xi) * eta } :
                                                 (i == 6 ? std::array<double, 2>{ -xi * eta * (1.0 + eta) ,
                                                                                (1.0 - xi) * (1.0 + xi) * (2.0 + 4.0 * eta)  } :
                                                 (i == 7 ? std::array<double, 2>{(2.0 - 4.0 * xi) * (1.0 - eta) * (1.0 + eta) ,
                                                                                  xi * (1.0 - xi) * eta } :
                                                           std::array<double, 2>{-2.0 * xi * (1.0 - eta*eta) ,
                                                                                -2.0 * (1.0 - xi*xi) * eta } ) ) ) ) ) ) ) );
                    std::array<double, 2> grad2 = (j == 0 ? std::array<double, 2>{(1.0 - 2.0 * xi) * eta * (1.0 - eta) ,
                                                                                 xi * (1.0 - xi) * (1.0 - 2.0 * eta) } :
                                                 (j == 1 ? std::array<double, 2>{-(1.0 + 2.0 * xi) * eta * (1.0 - eta),
                                                                                - xi * (1.0 + xi) * (1.0 - 2.0 * eta)} :
                                                 (j == 2 ? std::array<double, 2>{(1.0 + 2.0 * xi) * eta * (1.0 + eta) ,
                                                                                 xi * (1.0 + xi) * (1.0 + 2.0 * eta) } :
                                                 (j == 3 ? std::array<double, 2>{-(1.0 - 2.0 * xi) * eta * (1.0 + eta),
                                                                                - xi * (1.0 - xi) * (1.0 + 2.0 * eta)} :
                                                 (j == 4 ? std::array<double, 2>{xi * eta * (1.0 - eta) ,
                                                                                -(1.0 - xi) * (1.0 + xi) * (2.0 - 4.0 * eta) } :
                                                 (j == 5 ? std::array<double, 2>{(2.0 + 4.0 * xi) * (1.0 - eta) * (1.0 + eta) ,
                                                                                 -xi * (1.0 + xi) * eta } :
                                                 (j == 6 ? std::array<double, 2>{ -xi * eta * (1.0 + eta) ,
                                                                                (1.0 - xi) * (1.0 + xi) * (2.0 + 4.0 * eta)  } :
                                                 (j == 7 ? std::array<double, 2>{(2.0 - 4.0 * xi) * (1.0 - eta) * (1.0 + eta) ,
                                                                                  xi * (1.0 - xi) * eta } :
                                                           std::array<double, 2>{-2.0 * xi * (1.0 - eta*eta) ,
                                                                                -2.0 * (1.0 - xi*xi) * eta } ) ) ) ) ) ) ) );
