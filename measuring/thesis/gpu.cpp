...
void __K_assemble_element_Q1_O5_unrolled(const float* node_coords, const size_t* dof_ids, const float* quadpoints, const float* weights, const size_t num_elements,
                                         const size_t* const rowptr, const size_t* const colind, float* values, const size_t numrows);
...
//    __K_assemble_element_Q1_O5_unrolled(d_coords, d_dof, d_quadpoints, d_weights, numelem,
//                                        mat_gpu._rowptr, mat_gpu._colind, mat_gpu._values, mat_cpu._numrows);
//    __K_assemble_element_Q1_O5_LM(d_coords, d_dof, d_quadpoints, d_weights, numelem,
//                                  d_localmatrices);
//    __K_assemble_element_Q1_O5_LM_unrolled(d_coords, d_dof, d_quadpoints, d_weights, numelem,
//                                           d_localmatrices);
    ...
    //float values[50];
    //size_t colind[50];
    //memcpy_cuda(values, mat_gpu._values, 50*sizeof(float), d2h);
